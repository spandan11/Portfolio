    ...
    return (
        <header className='header'>
            ...
            <nav className="nav container">
                ...
                <a href="/" className='nav__logo'>Spandan</a>
                    ...
                    <ul className="nav__list grid">
                        ...
                        {/* <li className="nav__item">
                            <a href="#labs"
                                ...
                                className={activeNav === '#labs' ? "nav__link active__link" : "nav__link"}
                            >
                                <i className="uil uil-innovation nav__icon"></i>Labs
                            </a>
                        </li> */}
