...
const Data = () => {
    return (
        <div className="home__data">
            ...
            <h3 className="home__subtitle">Coding Ethusiast</h3>
            <p className="home__description">I'm an aspiring IT student proficient in web development, with expertise
                in front-end technologies and a solid foundation in back-end languages.
            </p>
